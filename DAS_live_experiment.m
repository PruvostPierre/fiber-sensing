%% DAS Live Experiment - Small acquisitions
...
p.tx.ovsFactor = 1;
p.fibre.L = 1000; %4200; %5200; % fiber length in meters [m] 
...
p.rx.data_filename = 'Acquire7'; % CHANGE ME  % filename without '_CH1.txt' for short acquisitions done with MATLAB, 
% with '.dat' for long acquisitions done with GageStream2Disk.exe

% Display parameters
p.displ.fIdx = 20;                 % Figure index for display
